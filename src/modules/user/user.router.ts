...
export const routes = {
	...
	reactivateMyAccount: '/reactivate-account',

	// getUserStatus: '/:userId/status', // online/lastSeenAt
};

// router.patch(routes.reactivateMyAccount, controller.reactivateMyAccount);
...
// delete my account
router.delete(routes.deleteMyAccount, controller.deleteMyAccount);
